...
An existing Python 3 implementation of the SCP framework\footnote{https://github.com/AxelInd/SequentialCognitionPrcoesses} has been able to model experiments related to the Suppression Task and the Wason Selection Task for both general and individual case reasoners using both the WCS and Reiter's Default Logic.
