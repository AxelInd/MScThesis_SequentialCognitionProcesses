...
oneside]{MastersDoctoralThesis} % The class file specifying the document structure
...
\usepackage{eso-pic} 
\usepackage{placeins}
\newenvironment{bulletProof}[1][\proofname]{%
  \begin{proof}[#1]$ $\par\nobreak\ignorespaces
}{%
  \end{proof}
}
...
\supervisor{Prof. Dr. Marco \textsc{Ragni}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\group{\href{https://www.cognitive-computation.uni-freiburg.de}{Cognitive Computation Lab}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\begin{titlepage}
\begin{center}
\AddToShipoutPicture*{\put(245,255){\includegraphics[scale=0.65]{logo-grundversion-01}}}
\vspace*{.06\textheight}
...
\emph{Author:}\\
\href{https://github.com/AxelInd/SCP_Implementation}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor \& Examiner~1:} \\
\href{http://www.cc.uni-freiburg.de/staff/marco-ragni}{\supname} % Supervisor name - remove the \href bracket to remove the link  

\emph{Examiner~2:} \\
\href{https://www.fernuni-hagen.de/wbs/people.html}{Prof. Dr. Christoph \textsc{Beierle}} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[4.5cm]
...
\include{Chapters/SCP}
\include{Chapters/Toolbox}
\include{Chapters/Mimic}
\include{Chapters/Comparing}
\include{Chapters/Program}
%\include{Chapters/NSCP}
